...
def downgrade() -> None:
    op.execute("DELETE FROM global_config WHERE key IN ('gas_threshold_warning', 'gas_threshold_critical', 'test_mode_timeout_minutes', 'alert_notification_timeout_seconds', 'data_retention_days')")
